...
function RouteComponent() {
  ...
  return <div>
    ...
    <Link to="/yeock" className="absolute grid place-items-center border-2 right-[5%] md:right-[calc(5%-15px)] top-10 m-5 text-[13px] w-20 h-14 md:top-[6%] md:h-[70px] md:w-[130px] md:text-[16px] rounded-lg">돌아가기</Link>
    <br />
