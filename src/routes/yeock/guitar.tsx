...
function RouteComponent() {
  ...
  return <div className='bg-[#006633] min-h-screen'>
    <br />
        <br />
        <p className="p-4 text-5xl font-bold ml-6 text-[#ffffff]">6판 / 만관</p>
    <Link to="/yeock" className="absolute grid place-items-center border-2 right-[5%] text-[#009933] bg-white top-10 m-5 text-[13px] w-20 h-14 md:top-[6%] md:h-[70px] md:w-[130px] md:text-[16px] rounded-lg">돌아가기</Link>
    <br />
