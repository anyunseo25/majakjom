...
function RouteComponent() {
  ...
  return <div className="min-h-dvh bg-[#006633]">
    ...
    <Link to="/yeock" className="absolute grid place-items-center bg-white text-[#cc0000] border-2 top-10 right-[5%] md:right-[calc(5%-15px)] m-5 text-[13px] w-20 h-14 md:top-[6%] md:h-[70px] md:w-[130px] md:text-[16px] rounded-lg">돌아가기</Link>
    <br />
